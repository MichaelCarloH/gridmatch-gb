...
export default function ResearchPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Research evidence" title="Transparent by construction." description="Executed notebooks, model cards, lineage and limitations behind every product surface." actions={<span className="badge status-executed">{notebooks.data?.meta?.count ?? '—'} notebooks executed</span>} />
      <DataState loading={loading} error={notebooks.error || models.error} />
      {!loading && <>
