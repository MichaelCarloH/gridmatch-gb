# Model card — gen_solar_cornwall

## Purpose

Day-ahead half-hourly generation forecasting for the simulated
`Tamar Solar` demo site. The stored stack includes a Ridge statistical model,
...
|---|---:|---:|---:|---:|
| physical_solar | 0.00901 | 0.01391 | 0.0058 | -0.00012 |
| persistence | 0.06220 | 0.10281 | 0.0401 | -0.00745 |
| previous_day | 0.06220 | 0.10281 | 0.0401 | -0.00745 |
| rolling_same_period | 0.07559 | 0.12082 | 0.0488 | -0.00261 |
| previous_week | 0.10526 | 0.17035 | 0.0679 | 0.01124 |
| hist_gradient_boosting | 0.00991 | 0.01603 | 0.0064 | -0.00140 |
| ridge | 0.00945 | 0.01437 | 0.0061 | -0.00019 |

The ML point model changes MAE by -9.98% versus the canonical
